              ...
              <FormControl fullWidth>
                ...
                <Select value={sortOption} onChange={handleSortChange}>
                  <MenuItem value="highest-rated">
                    {translations.MARKET_SORT.SORT1}
                  </MenuItem>
                  <MenuItem value="lowest-rated">
                    {translations.MARKET_SORT.SORT2}
                  </MenuItem>
                  <MenuItem value="most-reviews">
                    {translations.MARKET_SORT.SORT3}
                  </MenuItem>
                  <MenuItem value="least-reviews">
                    {translations.MARKET_SORT.SORT4}
                  </MenuItem>
                </Select>
              </FormControl>
            </Grid2>
